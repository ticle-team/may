...
import type {
  RecommendFunctionsSummary as _shaple_RecommendFunctionsSummary,
  RecommendFunctionsSummary__Output as _shaple_RecommendFunctionsSummary__Output,
} from '../shaple/RecommendFunctionsSummary';
