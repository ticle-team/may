...
import type {
  ShapleBuilderAIClient as _shaple_ShapleBuilderAIClient,
  ShapleBuilderAIDefinition as _shaple_ShapleBuilderAIDefinition,
} from './shaple/ShapleBuilderAI';
...
export interface ProtoGrpcType {
  shaple: {
    ...
    ShapleBuilderAI: SubtypeConstructor<
      typeof grpc.Client,
      _shaple_ShapleBuilderAIClient
    > & {
      service: _shaple_ShapleBuilderAIDefinition;
    };
