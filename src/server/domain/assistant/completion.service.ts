...
export class CompletionService {
  ...
  async generateCreatingStackStateInfo(
    ...
    const promptTemplateText = `당신은 Assistant와 유저의 대화인 \`Context\`를 보고 마지막에 진행한 step 번호와 추천된 VAPIs와 BaseAPIs 목록, 서비스의 이름 및 설명을 작성해야합니다. 당신은 VAPIs와 BaseAPIs 의 정확한 Name 을 작성해야 합니다. 만약, 대화 중 VAPIs와 BaseAPIs 목록이 아직 언급되지 않았다면, 해당 내용을 생략합니다. 당신은 절대로 허위로 내용을 작성하지 않습니다.
