...
export default function Step1Section({ handleNextStep }: { handleNextStep: () => void }) {
    ...
    <div className='min-w-[800px] max-w-7xl py-24'>
      <div className="space-y-12">
        <div className="border-b border-gray-900/10 pb-12">
          <h1 className="text-2xl font-semibold leading-9 text-gray-900 mb-12">Create Organization</h1>
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-4">
              <div className='flex gap-x-2'>
                ...
                <label htmlFor="username" className="block text-sm font-medium leading-6 text-orange-600">
                  *
                </label>
              </div>
              <div className="mt-2">
