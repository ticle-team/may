...
export default function Step2Section({ handleNextStep }: { handleNextStep: () => void }) {
            ...
            {tiers.map((tier) => (
              ...
              >
                ...
                <p className="mt-6 flex items-baseline gap-x-1">
                  ...
                  <span className="text-sm font-semibold leading-6 text-gray-600">{tier.freeAccess ? "" : frequency.priceSuffix}</span>
                </p>
                <button
